...
object CustomTaskListPlugin {
    fun create(
        ...
        return TaskListPlugin.create(
            checkedCheckboxColor.toArgb(), // checkedFillColor - fill color for checked checkboxes
            checkboxColor.toArgb(),         // normalOutlineColor - outline color for unchecked checkboxes  
            android.graphics.Color.WHITE    // checkMarkColor - color of the checkmark itself
        )
    }
}
